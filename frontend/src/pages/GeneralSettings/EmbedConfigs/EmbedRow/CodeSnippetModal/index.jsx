...
https://github.com/magnum15/anything-llm/tree/master/embed/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/LexBot-chat-widget.min.js">
</script>
<!-- LexBot (https://useanything.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/magnum15/anything-llm/tree/master/embed/README.md"
          target="_blank"
