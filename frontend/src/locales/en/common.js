const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Welcome to LexBot! We are excited to have you here. LexBot is your artificial intelligence legal assistant, designed to help you with various legal tasks. Explore the platform and discover how we can transform your legal practice!",
    part2:
      "LexBot is designed to improve your efficiency and accuracy in the legal field. We offer advanced tools for document writing, sentence analysis and much more. For now, the chat section is disabled until the payment process is completed.",
    part3:
      "To enable the chat section, pay your subscription by bank transfer. Once payment is received, we will activate your subscription. Please complete the form with your payment information in the following link. Thank you for your patience.",
    githubIssue: "Subscribe Now!",
    user1: "How do I start because I can't chat?!",
    part4:
      "The chat section is disabled until you complete the payment process. Make your bank transfer and complete the form with your payment information to activate your subscription.",
    createWorkspace: "Create your first workspace",
    user2:
      "This looks great, how can it help me in my legal practice?",
    part5:
      "LexBot helps you automate repetitive tasks, analyze large volumes of information, and provide accurate legal advice. This improves your efficiency, reduces errors and allows you to focus on more complex and strategic cases.",
    user3: "Wow, this sounds amazing, let me try it now!",
    part6: "We're glad you're excited! To enable all features, make your payment via bank transfer and fill out the form with your payment information at the link below. We look forward to helping you improve your legal practice.",
    starOnGithub: "Subscribe Now!",
    contact: "Contact Lexbot Team",
  },
  ...
  appearance: {
    ...
    message: {
      ...
      user: "user",
      message: "message",
      assistant: "LexBot Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this LexBot instance.",
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else LexBot will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall LexBot when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which LexBot can use to process.",
    provider: {
      title: "Embedding Provider",
      description:
        "There is no set up required when using LexBot's native embedding engine.",
    },
  },
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your LexBot instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protect your LexBot instance with a password. If you forget this there is no recovery method so ensure you save this password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and LexBot handle your data.",
    llm: "LLM Selection",
